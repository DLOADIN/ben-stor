...
const capImages: CapImage[] = [
  { id: 1, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773240176/WhatsApp_Image_2026-02-19_at_12.32.30_kqwiu6.jpg", category: "Snapback" },
  { id: 2, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773240175/WhatsApp_Image_2026-02-19_at_12.32.29_pcc2dq.jpg", category: "Fitted Cap" },
...
export default function StreetWearCapsCarousel() {
  ...
  const totalItems = capImages.length
  ...
  const currentItem = capImages[currentIndex]
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
            BS <span className="text-gray-600">Street Wear Caps</span>
          </h2>
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            Top off your look with our premium street wear cap collection
          </p>
        </motion.div>
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-8">
          {['Snapback', 'Fitted Cap', 'Dad Hat', 'Trucker Cap', 'Street Cap'].map((category) => {
            const catIndex = capImages.findIndex(a => a.category === category)
