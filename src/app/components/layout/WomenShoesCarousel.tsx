...
interface WomenShoeImage {
  id: number
  image: string
  category: string
}

const womenShoeImages: WomenShoeImage[] = [
  { id: 1, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773239598/WhatsApp_Image_2026-02-19_at_12.33.18_sz3mxe.jpg", category: "Heels" },
  { id: 2, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773239597/WhatsApp_Image_2026-02-19_at_11.35.deik_dsal0d.jpg", category: "Flats" },
  { id: 3, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773239597/WhatsApp_Image_2026-02-19_at_11.35.222w_f9cvhi.jpg", category: "Sandals" },
  { id: 4, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773239597/WhatsApp_Image_2026-02-19_at_11.35.16_rcngnn.jpg", category: "Wedges" },
  { id: 5, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773239596/WhatsApp_Image_2026-02-19_at_11.34.31_n0twav.jpg", category: "Boots" },
  { id: 6, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773239596/WhatsApp_Image_2026-02-19_at_11.33.45_tbiqdt.jpg", category: "Heels" },
  { id: 7, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773239595/WhatsApp_Image_2026-02-19_at_11.32.29_rcmrln.jpg", category: "Flats" },
  { id: 8, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773239595/WhatsApp_Image_2026-02-19_at_11.14.58_d9boqm.jpg", category: "Sandals" },
  { id: 9, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773239595/WhatsApp_Image_2026-02-19_at_11.06.58_gagtye.jpg", category: "Wedges" },
  { id: 10, image: "https://res.cloudinary.com/dyqfyqtjl/image/upload/v1773239594/WhatsApp_Image_2026-02-19_at_11.05.41_ppt1wm.jpg", category: "Boots" },
]

export default function WomenShoesCarousel() {
  ...
  const totalItems = womenShoeImages.length
  ...
  useEffect(() => {
    womenShoeImages.forEach((item, index) => {
      const img = new Image()
  ...
  const currentItem = womenShoeImages[currentIndex]
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
            BS <span className="text-gray-600">Women Shoes</span>
          </h2>
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            Walk with confidence in our stunning women's shoe collection
          </p>
        </motion.div>
          ...
          >
            <AnimatePresence mode="sync">
              {getVisibleIndices().map((index) => {
                const item = womenShoeImages[index]
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-8">
          {[''].map((category) => {
            const catIndex = womenShoeImages.findIndex(a => a.category === category)
